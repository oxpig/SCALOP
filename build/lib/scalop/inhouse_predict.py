...
def _assign(sequence, cdr,scheme,definition,dbv):
...
def assign(seq,scheme='imgt',definition='north',dbv='latest'):
    '''
    ...
    for i in range(len(numberedseqs[0])):
        ...
        for cdr in cdrs[chain]:
            ...
            # Assign canonical form
            assignresults[i].update({cdr:_assign(loop,cdr)})
